            ...
            <div class="col-6">
              <div class="px-4 pt-4 pb-2 rounded-4 h-100" style="background-color: #F5F5F5">
                ...
                <div class="time mt-4">
                  <ul>
                    <li>
                      <input type="checkbox" name="time" id="08:00" />
                    ...
                    <li>
                      <input type="checkbox" name="time" id="09:30" />
                    ...
                    <li>
                      <input type="checkbox" name="time" id="10:30" />
                    ...
                    <li>
                      <input type="checkbox" name="time" id="13:00" />
                    ...
                    <li>
                      <input type="checkbox" name="time" id="15:00" />
                    ...
                    <li>
                      <input type="checkbox" name="time" id="16:30" />
          ...
          <form action="">
            <div class="row">
              ...
              <div class="d-flex w-100 justify-content-end">
                <button type="button" class="btn text-white text-3xs border-0 status submit-button" style="background-color:#507CA5;" disabled>Submit</button>
              </div>
            </div>
          </form>
        </div>
...
@section('myscript')
  ...
  <script>
    document.addEventListener('DOMContentLoaded', (event) => {   
      let myModal = new bootstrap.Modal(document.getElementById("jadwalModal"));
      myModal.show();
